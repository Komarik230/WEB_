...
;( function( window ) {
    ...
    function Photostack( el, options ) {
        ...
        lpbuilderItemsCount = this.items.length - 1;
    ...
    Photostack.prototype._addNavigation = function() {
        ...
        this.wrapper.className = "lpbuilder-photostack-nav-wrapper";
        this.prevArrow = document.createElement( 'span' );
        this.prevArrow.className = "lpbuilder-photostack-prev";
        this.nextArrow = document.createElement( 'span' );
        this.nextArrow.className = "lpbuilder-photostack-next";
    ...
    Photostack.prototype._initEvents = function() {
        ...
        jQuery(this.nextArrow).on('click', function () {
            var lpbuilderidx = self.current;
            if( lpbuilderidx === lpbuilderItemsCount ) {
                lpbuilderidx = 0;
                var callback = function() { self._showPhoto( lpbuilderidx ); }
            } else {
                lpbuilderidx = lpbuilderidx + 1;
                var callback = function() { self._showPhoto( lpbuilderidx ); }
            }
            callback();
        });
        ...
        jQuery(this.prevArrow).on('click', function () {
            ...
            if( lpbuilderidx === 0 ) {
                lpbuilderidx = lpbuilderItemsCount;
                var callback = function() { self._showPhoto( lpbuilderidx ); }
            } else {
                lpbuilderidx = lpbuilderidx - 1;
                var callback = function() { self._showPhoto( lpbuilderidx ); }
